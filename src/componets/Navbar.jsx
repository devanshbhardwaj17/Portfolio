...
export default function Navbar() {
    return (
        <div className=' flex flex-wrap justify-between items-center'>
            ...
            <div className=' bg-gray-800 bg-opacity-90 md:w-[50%] sm:w-[60%] w-full float-end sm:rounded-bl-xl sm:py-3 shadow-sm shadow-[#565656] mt-2 sm:mt-0 mx-3 py-1 rounded-2xl sm:rounded-none sm:mx-0'>
